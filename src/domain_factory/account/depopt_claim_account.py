...
class DepotClaimAccount(ECPAccount):
    """ Class to generate depot claim ecp accounts. Generate method will call the
    ECPAccount generate method in order to populate fields shared by all ECP
    accounts. The generate method in this class will then populate the remaining
    attributes unique to the Depot Claim Account domain factory. """
