...
class Coordinator():
    ...
    def create_jobs(self, object_factory):
        ...
        """
        start_id = 0
        record_count = object_factory.get_record_count()
        job_size = object_factory.get_shared_args()['pool_job_size']
    ...
    def start_generator(self, object_factory):
    ...
    def start_writer(self, object_factory):
        ...
        writer_pool_size =\
            object_factory.get_shared_args()['writer_pool_size']
